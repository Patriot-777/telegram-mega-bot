...
function checkDay() { var date = new Date(); if (date.getHours() <= 4 || date.getHours() >= 12) return;
    switch(date.getDay()) {
        ...
        if (dateHours == "5" && dateMinutes == "20") bot.sendMessage(655231019, `Зараз буде така пара: ${pary["2"]["0"]}\n\nПочаток/Кiнець: ${timeDzilin["0"]}`);
        else if (dateHours == "5" && dateMinutes == "25") bot.sendMessage(655231019, `Хто прийде пiсля дзвоника - опоздун!`);
        else if (dateHours == "6" && dateMinutes == "45") bot.sendMessage(655231019, `Зараз буде така пара: ${pary["2"]["1"]}\n\nПочаток/Кiнець: ${timeDzilin["1"]}`);
        else if (dateHours == "8" && dateMinutes == "10") bot.sendMessage(655231019, `Зараз буде така пара: ${pary["2"]["2"]}\n\nПочаток/Кiнець: ${timeDzilin["2"]}`);
        else if (dateHours == "9" && dateMinutes == "35") bot.sendMessage(655231019, `Зараз буде така пара: ${pary["2"]["3"]}\n\nПочаток/Кiнець: ${timeDzilin["3"]}`);
        else if (dateHours == "11" && dateMinutes == "0") bot.sendMessage(655231019, `Бiльше пар сьогодi не буде.\n\nЗавтра будуть такi пари:\n\n ${pary["3"]["0"]}\n\n${pary["3"]["1"]}\n\n${pary["3"]["2"]}`);
        else return;
        break;
        ...
        if (dateHours == "5" && dateMinutes == "20") bot.sendMessage(655231019, `Зараз буде така пара: ${pary["4"]["0"]}\n\nПочаток/Кiнець: ${timeDzilin["0"]}`);
        else if (dateHours == "5" && dateMinutes == "25") bot.sendMessage(655231019, `Хто прийде пiсля дзвоника - опоздун!`);
        else if (dateHours == "8" && dateMinutes == "45") bot.sendMessage(655231019, `Зараз буде така пара: ${pary["4"]["1"]}\n\nПочаток/Кiнець: ${timeDzilin["1"]}`);
        else if (dateHours == "9" && dateMinutes == "10") bot.sendMessage(655231019, `Зараз буде така пара: ${pary["4"]["2"]}\n\nПочаток/Кiнець: ${timeDzilin["2"]}`);
        else if (dateHours == "11" && dateMinutes == "20") bot.sendMessage(655231019, `Бiльше пар сьогодi не буде.\n\nЗавтра будуть такi пари:\n\n ${pary["5"]["0"]}\n\n${pary["5"]["1"]}\n\n${pary["5"]["2"]}`);
        else return;
        break;
        case 5: var dateHours = new Date().getHours(); var dateMinutes = new Date().getMinutes();
        if (dateHours == "5" && dateMinutes == "20") bot.sendMessage(655231019, `Зараз буде така пара: ${pary["5"]["0"]}\n\nПочаток/Кiнець: ${timeDzilin["0"]}`);
        else if (dateHours == "5" && dateMinutes == "25") bot.sendMessage(655231019, `Хто прийде пiсля дзвоника - опоздун!`);
        else if (dateHours == "8" && dateMinutes == "45") bot.sendMessage(655231019, `Зараз буде така пара: ${pary["5"]["1"]}\n\nПочаток/Кiнець: ${timeDzilin["1"]}`);
        else if (dateHours == "9" && dateMinutes == "10") bot.sendMessage(655231019, `Зараз буде така пара: ${pary["5"]["2"]}\n\nПочаток/Кiнець: ${timeDzilin["2"]}`);
